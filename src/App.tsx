...
const MainAppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans flex flex-col antialiased selection:bg-emerald-500 selection:text-white" dir="rtl">
      ...
      <div className="flex-1 flex flex-col lg:flex-row w-full p-3 sm:p-4 lg:p-6 gap-5">
        {/* Sidebar Navigation - Sticky on Right side in RTL */}
        ...
        {/* Main Active Module Content - Full Width to the left of the right sidebar */}
