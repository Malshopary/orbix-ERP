...
export const WatermarkWorkspace: React.FC<WatermarkWorkspaceProps> = ({ setActiveTab }) => {
  ...
  return (
    <div className="relative w-full h-full min-h-[380px] flex-1 flex flex-col items-center justify-center p-4 sm:p-6 select-none overflow-hidden my-auto">
      {/* Background Giant Watermark - Official Vector Logo */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.045] select-none z-0 overflow-hidden">
        <svg
          viewBox="152 523 775 304"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-[85vw] max-w-[760px] max-h-[60vh] object-contain"
          aria-hidden="true"
        >
          {/* Top Right Blade */}
          <path
          ...
          />
          {/* Central Green Orb */}
          <circle cx="296.288" cy="675.003" r="45.399" fill="#0FBE7B" />

          {/* Typography: O */}
          <path
            fill="#04235E"
            d="M526.611,620.432c-29.17,0-52.82,23.65-52.82,52.82c0,29.17,23.65,52.82,52.82,52.82 c29.17,0,52.82-23.65,52.82-52.82C579.431,644.082,555.781,620.432,526.611,620.432z M549.381,693.432 c-5,7.31-12.7,11.23-21.71,11.57c-9.2,0.35-17.1-3.1-22.66-10.13c-8.25-10.43-9.43-24.54-3.96-36.69 c3.72-8.27,11.14-14.33,19.23-16c9.67-2,19.2,0.21,25.89,7.29C557.471,661.422,558.581,679.992,549.381,693.432z"
          />
          {/* Typography: R */}
          <path
            fill="#04235E"
            d="M657.101,690.032c17.24-8.35,22.31-27.82,16.54-45.04c-3.01-8.49-8.98-14.93-17.16-18.6 c-6.06-2.76-12.35-4.02-19.16-4.02l-43.05-0.01l0.04,101.7l23.02,0.02l0.09-29.86l17.17,0.05l19.02,29.81l25.21-0.15 L657.101,690.032z M637.401,674.422l-20.05,0.19l-0.02-32.47l21.01,0.21c8.46,0.09,14.56,7.23,13.93,15.85 C652.751,667.412,646.241,673.802,637.401,674.422z"
          />
          {/* Typography: B */}
          <path
            fill="#04235E"
            d="M762.311,670.772c7.62-4.55,11.29-12.6,11.23-21.46c-0.07-10.6-5.64-19.77-15.61-23.62 c-5.39-2.33-11.07-3.32-17.14-3.32h-48.5l0.02,101.72l52.8-0.05c6.29-0.01,12.05-1.22,17.71-3.43 c5.86-2.52,10.48-6.51,13.16-12.36C781.552,693.702,777.481,677.592,762.311,670.772z M715.421,641.272l25.57,0.15 c5.7,0.67,10.09,4.74,9.58,10.87c0.24,6.25-4.28,10.67-10.22,10.71l-24.93,0.18V641.272z M753.302,700.452 c-2.66,3.25-6.46,4.15-10.39,4.56l-27.52,0.12l0.01-23.43l27.05,0.02c4.01,0.21,7.56,1.59,10.36,4.39 C755.451,690.392,756.031,695.892,753.302,700.452z"
          />
          {/* Typography: I */}
          <rect x="792.944" y="622.328" width="23.159" height="101.806" fill="#04235E" />
          {/* Typography: X */}
          <polygon
            fill="#04235E"
            points="925.6,724.039 898.54,724.066 875.625,689.443 852.54,723.989 825.941,724.018 861.521,671.537 828.051,622.36 854.723,622.406 875.892,654.277 897.269,622.406 923.352,622.42 889.728,671.551"
          />
        </svg>
      </div>
