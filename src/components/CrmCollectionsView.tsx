      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs">
        ...
        <div className="flex flex-wrap gap-2 mt-6 pt-2">
          ...
          >
            ...
            دليل وسجل العملاء ({customers.length})
          </button>
          <button
            type="button"
          ...
          >
            ...
            مسار المبيعات والفرص البيعية ({crmLeads.length})
          </button>
          <button
            type="button"
            onClick={() => { setActiveTab('interactions'); setStatusFilter('all'); }}
            className={`px-4 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 cursor-pointer transition-all ${
              activeTab === 'interactions'
                ? 'bg-slate-900 text-white shadow-xs'
                : 'bg-slate-100 hover:bg-slate-200 text-slate-600'
          ...
          >
            ...
            سجل المتابعات والاتصالات ({crmInteractions.length})
          </button>
          <button
            type="button"
          ...
          >
            ...
            تذاكر الدعم والشكاوى ({crmTickets.length})
          </button>
          <button
            type="button"
            onClick={() => { setActiveTab('sales_reps'); setStatusFilter('all'); }}
            className={`px-4 py-2.5 rounded-xl font-bold text-xs flex items-center gap-2 cursor-pointer transition-all ${
          ...
          >
            ...
            مناديب المبيعات والأهداف ({salesReps.length})
          </button>
        </div>
      </div>
